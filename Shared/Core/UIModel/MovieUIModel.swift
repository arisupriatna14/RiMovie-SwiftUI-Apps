...
struct MovieUIModel: Equatable, Identifiable {
  ...
  let voteCount: Int
  let videos: [MovieVideoUIModel]
  let cast: [MovieCastUIModel]
  let crew: [MovieCrewUIModel]
  ...
  var youtubeTrailers: [MovieVideoUIModel]? {
